...
specific_dat <- dat %>% select(educ,edloan,employ,CC18_308a)
...
#### Write your code below:
specific_dat_v2 <- specific_dat %>% mutate(trump_approve_disapprove = recode(CC18_308a,
                                                                             "1" = "1",
                                                                             "2" = "1",
                                                                             "3" = "0",
                                                                             "4" = "0"))
print(specific_dat_v2)
...
dat %>% 
  ...
  summarise("Mean Importance of Religion" = mean(pew_religimp), "Median Importance of Religion" = median(pew_religimp))
